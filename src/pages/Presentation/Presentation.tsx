...
export function Presentation() {
  ...
  return (
    <div className="presentation">
      ...
      {mobile && <Btn className="left-btn" text="‹" onClick={() => setCurrentIndex((o) => o - 1)} />}
      {mobile && <Btn className="right-btn" text="›" onClick={() => setCurrentIndex((o) => o + 1)} />}
    </div>
  )
}
...
function First() {
  ...
  return (
    <div className="first-slide">
      ...
      {!mobile && <div style={{ position: 'absolute', bottom: '5%', right: '5%' }}>USE ARROWS TO NAVIGATE</div>}
    </div>
  )
}
  ...
  return (
    <div className="globe-slide">
      <div className="globe-attacks-info">
        <div className="globe-attacks-info-i scale-flex">
          <p>{countryName}</p>
          <GlobeCounters
...
function TopTerroristGroups() {
  return (
    <div className="top-terrorist-groups">
      ...
      <TerroristGroups forceMobile={true} />
    </div>
  )
}
